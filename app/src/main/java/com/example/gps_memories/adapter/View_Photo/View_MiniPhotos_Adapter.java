...
public class View_MiniPhotos_Adapter extends RecyclerView.Adapter<View_MiniPhotos_Adapter.Viewholder> {
    ...
    public View_MiniPhotos_Adapter(List<String> photos, Context context) {

...
import static com.example.gps_memories.controller.Memory.EditActivity.editmemoryphotoslist;


public class Edit_Memory_Photos_Adapter extends RecyclerView.Adapter<Edit_Memory_Photos_Adapter.Viewholder> {
    ...
    public Edit_Memory_Photos_Adapter(List<String> photos, Context context) {
       ...
       // Toast.makeText(context, photoslist.get(0), Toast.LENGTH_LONG).show();
            ...
            holder.deletebtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    editmemoryphotoslist.remove(editmemoryphotoslist.get(position));

                    if (editmemoryphotoslist.size() > 0) {
